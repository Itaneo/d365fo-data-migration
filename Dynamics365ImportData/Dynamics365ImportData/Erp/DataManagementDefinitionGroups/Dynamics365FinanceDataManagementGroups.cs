...
public class Dynamics365FinanceDataManagementGroups : Dynamics365FnoClient, IDynamics365FinanceDataManagementGroups
{
    ...
    public async Task<BlobDefinition> GetAzureWriteUrl(string uniqueFileName, CancellationToken cancellationToken = default)
    {
        return await PostRequestAsync<UniqueFileNameRequest, BlobDefinition>(nameof(GetAzureWriteUrl),
